...
class Chart extends StatelessWidget {
  ...
  List<ExpanseBucket> get buckets {
    return [
      ExpanseBucket.forCategory(expenses, Categories.food),
      ExpanseBucket.forCategory(expenses, Categories.leisure),
      ExpanseBucket.forCategory(expenses, Categories.travel),
      ExpanseBucket.forCategory(expenses, Categories.work),
    ];
  }
